...
pub type rseq_cpu_id_state = ::std::os::raw::c_schar;
pub const rseq_flags_RSEQ_FLAG_UNREGISTER: rseq_flags = 1;
pub type rseq_flags = ::std::os::raw::c_uchar;
...
pub type rseq_cs_flags_bit = ::std::os::raw::c_uchar;
...
pub type rseq_cs_flags = ::std::os::raw::c_uchar;
#[repr(C)]
#[repr(align(32))]
#[derive(Copy, Clone)]
pub struct rseq_cs {

...
pub use linux_headers_asm_unistd::__NR_fork;
pub use linux_headers_asm_unistd::__NR_read;
pub use linux_headers_asm_unistd::__NR_write;
pub use linux_headers_asm_unistd::__NR_open;
pub use linux_headers_asm_unistd::__NR_close;
pub use linux_headers_asm_unistd::__NR_wait4;
pub use linux_headers_asm_unistd::__NR_creat;
pub use linux_headers_asm_unistd::__NR_link;
pub use linux_headers_asm_unistd::__NR_unlink;
pub use linux_headers_asm_unistd::__NR_execv;
pub use linux_headers_asm_unistd::__NR_chdir;
pub use linux_headers_asm_unistd::__NR_chown;
pub use linux_headers_asm_unistd::__NR_mknod;
pub use linux_headers_asm_unistd::__NR_chmod;
pub use linux_headers_asm_unistd::__NR_lchown;
pub use linux_headers_asm_unistd::__NR_brk;
pub use linux_headers_asm_unistd::__NR_perfctr;
...
pub use linux_headers_asm_unistd::__NR_alarm;
pub use linux_headers_asm_unistd::__NR_sigaltstack;
pub use linux_headers_asm_unistd::__NR_pause;
pub use linux_headers_asm_unistd::__NR_utime;
pub use linux_headers_asm_unistd::__NR_lchown32;
pub use linux_headers_asm_unistd::__NR_fchown32;
pub use linux_headers_asm_unistd::__NR_access;
pub use linux_headers_asm_unistd::__NR_nice;
pub use linux_headers_asm_unistd::__NR_chown32;
pub use linux_headers_asm_unistd::__NR_sync;
pub use linux_headers_asm_unistd::__NR_kill;
pub use linux_headers_asm_unistd::__NR_stat;
pub use linux_headers_asm_unistd::__NR_sendfile;
pub use linux_headers_asm_unistd::__NR_lstat;
pub use linux_headers_asm_unistd::__NR_dup;
pub use linux_headers_asm_unistd::__NR_pipe;
pub use linux_headers_asm_unistd::__NR_times;
pub use linux_headers_asm_unistd::__NR_getuid32;
...
pub use linux_headers_asm_unistd::__NR_signal;
...
pub use linux_headers_asm_unistd::__NR_getgid32;
pub use linux_headers_asm_unistd::__NR_ioctl;
pub use linux_headers_asm_unistd::__NR_reboot;
pub use linux_headers_asm_unistd::__NR_mmap2;
pub use linux_headers_asm_unistd::__NR_symlink;
pub use linux_headers_asm_unistd::__NR_readlink;
...
pub use linux_headers_asm_unistd::__NR_fstat64;
pub use linux_headers_asm_unistd::__NR_getpagesize;
pub use linux_headers_asm_unistd::__NR_msync;
pub use linux_headers_asm_unistd::__NR_vfork;
pub use linux_headers_asm_unistd::__NR_pread64;
pub use linux_headers_asm_unistd::__NR_pwrite64;
pub use linux_headers_asm_unistd::__NR_geteuid32;
pub use linux_headers_asm_unistd::__NR_getegid32;
pub use linux_headers_asm_unistd::__NR_mmap;
pub use linux_headers_asm_unistd::__NR_setreuid32;
...
pub use linux_headers_asm_unistd::__NR_truncate64;
...
pub use linux_headers_asm_unistd::__NR_getpgrp;
pub use linux_headers_asm_unistd::__NR_setgroups32;
pub use linux_headers_asm_unistd::__NR_setitimer;
pub use linux_headers_asm_unistd::__NR_ftruncate64;
pub use linux_headers_asm_unistd::__NR_swapon;
pub use linux_headers_asm_unistd::__NR_getitimer;
pub use linux_headers_asm_unistd::__NR_setuid32;
pub use linux_headers_asm_unistd::__NR_sethostname;
pub use linux_headers_asm_unistd::__NR_setgid32;
pub use linux_headers_asm_unistd::__NR_dup2;
pub use linux_headers_asm_unistd::__NR_setfsuid32;
pub use linux_headers_asm_unistd::__NR_fcntl;
pub use linux_headers_asm_unistd::__NR_select;
pub use linux_headers_asm_unistd::__NR_setfsgid32;
...
pub use linux_headers_asm_unistd::__NR_setresuid32;
pub use linux_headers_asm_unistd::__NR_getresuid32;
pub use linux_headers_asm_unistd::__NR_setresgid32;
pub use linux_headers_asm_unistd::__NR_getresgid32;
pub use linux_headers_asm_unistd::__NR_setregid32;
pub use linux_headers_asm_unistd::__NR_recvmsg;
pub use linux_headers_asm_unistd::__NR_sendmsg;
pub use linux_headers_asm_unistd::__NR_getgroups32;
...
pub use linux_headers_asm_unistd::__NR_rename;
...
pub use linux_headers_asm_unistd::__NR_lstat64;
...
pub use linux_headers_asm_unistd::__NR_mkdir;
pub use linux_headers_asm_unistd::__NR_rmdir;
pub use linux_headers_asm_unistd::__NR_utimes;
pub use linux_headers_asm_unistd::__NR_stat64;
pub use linux_headers_asm_unistd::__NR_sendfile64;
...
pub use linux_headers_asm_unistd::__NR_pciconfig_read;
pub use linux_headers_asm_unistd::__NR_pciconfig_write;
pub use linux_headers_asm_unistd::__NR_getsockname;
pub use linux_headers_asm_unistd::__NR_inotify_init;
pub use linux_headers_asm_unistd::__NR_inotify_add_watch;
pub use linux_headers_asm_unistd::__NR_poll;
pub use linux_headers_asm_unistd::__NR_getdents64;
pub use linux_headers_asm_unistd::__NR_fcntl64;
...
pub use linux_headers_asm_unistd::__NR_umount;
pub use linux_headers_asm_unistd::__NR_sched_set_affinity;
pub use linux_headers_asm_unistd::__NR_sched_get_affinity;
pub use linux_headers_asm_unistd::__NR_getdomainname;
...
pub use linux_headers_asm_unistd::__NR_ustat;
...
pub use linux_headers_asm_unistd::__NR_getdents;
...
pub use linux_headers_asm_unistd::__NR_sigpending;
pub use linux_headers_asm_unistd::__NR_query_module;
...
pub use linux_headers_asm_unistd::__NR_epoll_create;
pub use linux_headers_asm_unistd::__NR_epoll_ctl;
pub use linux_headers_asm_unistd::__NR_epoll_wait;
pub use linux_headers_asm_unistd::__NR_ioprio_set;
pub use linux_headers_asm_unistd::__NR_getppid;
pub use linux_headers_asm_unistd::__NR_sigaction;
pub use linux_headers_asm_unistd::__NR_sgetmask;
pub use linux_headers_asm_unistd::__NR_ssetmask;
pub use linux_headers_asm_unistd::__NR_sigsuspend;
pub use linux_headers_asm_unistd::__NR_oldlstat;
pub use linux_headers_asm_unistd::__NR_uselib;
pub use linux_headers_asm_unistd::__NR_readdir;
pub use linux_headers_asm_unistd::__NR_readahead;
pub use linux_headers_asm_unistd::__NR_socketcall;
...
pub use linux_headers_asm_unistd::__NR_fadvise64_64;
pub use linux_headers_asm_unistd::__NR_tgkill;
pub use linux_headers_asm_unistd::__NR_waitpid;
pub use linux_headers_asm_unistd::__NR_swapoff;
pub use linux_headers_asm_unistd::__NR_sysinfo;
pub use linux_headers_asm_unistd::__NR_ipc;
pub use linux_headers_asm_unistd::__NR_sigreturn;
...
pub use linux_headers_asm_unistd::__NR_sigprocmask;
pub use linux_headers_asm_unistd::__NR_create_module;
pub use linux_headers_asm_unistd::__NR_delete_module;
pub use linux_headers_asm_unistd::__NR_get_kernel_syms;
pub use linux_headers_asm_unistd::__NR_getpgid;
pub use linux_headers_asm_unistd::__NR_bdflush;
pub use linux_headers_asm_unistd::__NR_sysfs;
pub use linux_headers_asm_unistd::__NR_afs_syscall;
pub use linux_headers_asm_unistd::__NR_setfsuid;
pub use linux_headers_asm_unistd::__NR_setfsgid;
pub use linux_headers_asm_unistd::__NR__newselect;
pub use linux_headers_asm_unistd::__NR_time;
pub use linux_headers_asm_unistd::__NR_splice;
pub use linux_headers_asm_unistd::__NR_stime;
pub use linux_headers_asm_unistd::__NR_statfs64;
pub use linux_headers_asm_unistd::__NR_fstatfs64;
pub use linux_headers_asm_unistd::__NR__llseek;
...
pub use linux_headers_asm_unistd::__NR__sysctl;
...
pub use linux_headers_asm_unistd::__NR_vserver;
...
pub use linux_headers_asm_unistd::__NR_futimesat;
pub use linux_headers_asm_unistd::__NR_fstatat64;
...
pub use linux_headers_asm_unistd::__NR_signalfd;
pub use linux_headers_asm_unistd::__NR_timerfd_create;
pub use linux_headers_asm_unistd::__NR_eventfd;
...
pub use linux_headers_asm_unistd::__NR_kern_features;
...
pub use linux_headers_asm_unistd::__NR_clock_gettime64;
pub use linux_headers_asm_unistd::__NR_clock_settime64;
pub use linux_headers_asm_unistd::__NR_clock_adjtime64;
pub use linux_headers_asm_unistd::__NR_clock_getres_time64;
pub use linux_headers_asm_unistd::__NR_clock_nanosleep_time64;
pub use linux_headers_asm_unistd::__NR_timer_gettime64;
pub use linux_headers_asm_unistd::__NR_timer_settime64;
pub use linux_headers_asm_unistd::__NR_timerfd_gettime64;
pub use linux_headers_asm_unistd::__NR_timerfd_settime64;
pub use linux_headers_asm_unistd::__NR_utimensat_time64;
pub use linux_headers_asm_unistd::__NR_pselect6_time64;
pub use linux_headers_asm_unistd::__NR_ppoll_time64;
pub use linux_headers_asm_unistd::__NR_io_pgetevents_time64;
pub use linux_headers_asm_unistd::__NR_recvmmsg_time64;
pub use linux_headers_asm_unistd::__NR_mq_timedsend_time64;
pub use linux_headers_asm_unistd::__NR_mq_timedreceive_time64;
pub use linux_headers_asm_unistd::__NR_semtimedop_time64;
pub use linux_headers_asm_unistd::__NR_rt_sigtimedwait_time64;
pub use linux_headers_asm_unistd::__NR_futex_time64;
pub use linux_headers_asm_unistd::__NR_sched_rr_get_interval_time64;
...
pub use linux_headers_linux_auxvec::AT_ADI_BLKSZ;
pub use linux_headers_linux_auxvec::AT_ADI_NBITS;
pub use linux_headers_linux_auxvec::AT_ADI_UEONADI;
...
mod linux_headers_linux_membarrier;
pub use linux_headers_linux_membarrier::membarrier_cmd_MEMBARRIER_CMD_QUERY;
pub use linux_headers_linux_membarrier::membarrier_cmd_MEMBARRIER_CMD_GLOBAL;
pub use linux_headers_linux_membarrier::membarrier_cmd_MEMBARRIER_CMD_GLOBAL_EXPEDITED;
pub use linux_headers_linux_membarrier::membarrier_cmd_MEMBARRIER_CMD_REGISTER_GLOBAL_EXPEDITED;
pub use linux_headers_linux_membarrier::membarrier_cmd_MEMBARRIER_CMD_PRIVATE_EXPEDITED;
pub use linux_headers_linux_membarrier::membarrier_cmd_MEMBARRIER_CMD_REGISTER_PRIVATE_EXPEDITED;
pub use linux_headers_linux_membarrier::membarrier_cmd_MEMBARRIER_CMD_PRIVATE_EXPEDITED_SYNC_CORE;
pub use linux_headers_linux_membarrier::membarrier_cmd_MEMBARRIER_CMD_REGISTER_PRIVATE_EXPEDITED_SYNC_CORE;
pub use linux_headers_linux_membarrier::membarrier_cmd_MEMBARRIER_CMD_PRIVATE_EXPEDITED_RSEQ;
pub use linux_headers_linux_membarrier::membarrier_cmd_MEMBARRIER_CMD_REGISTER_PRIVATE_EXPEDITED_RSEQ;
pub use linux_headers_linux_membarrier::membarrier_cmd_MEMBARRIER_CMD_GET_REGISTRATIONS;
pub use linux_headers_linux_membarrier::membarrier_cmd_MEMBARRIER_CMD_SHARED;
pub use linux_headers_linux_membarrier::membarrier_cmd;
pub use linux_headers_linux_membarrier::membarrier_cmd_flag_MEMBARRIER_CMD_FLAG_CPU;
pub use linux_headers_linux_membarrier::membarrier_cmd_flag;
...
mod linux_headers_linux_rseq;
pub use linux_headers_linux_rseq::rseq_cpu_id_state_RSEQ_CPU_ID_UNINITIALIZED;
pub use linux_headers_linux_rseq::rseq_cpu_id_state_RSEQ_CPU_ID_REGISTRATION_FAILED;
pub use linux_headers_linux_rseq::rseq_cpu_id_state;
pub use linux_headers_linux_rseq::rseq_flags_RSEQ_FLAG_UNREGISTER;
pub use linux_headers_linux_rseq::rseq_flags;
pub use linux_headers_linux_rseq::rseq_cs_flags_bit_RSEQ_CS_FLAG_NO_RESTART_ON_PREEMPT_BIT;
pub use linux_headers_linux_rseq::rseq_cs_flags_bit_RSEQ_CS_FLAG_NO_RESTART_ON_SIGNAL_BIT;
pub use linux_headers_linux_rseq::rseq_cs_flags_bit_RSEQ_CS_FLAG_NO_RESTART_ON_MIGRATE_BIT;
pub use linux_headers_linux_rseq::rseq_cs_flags_bit;
pub use linux_headers_linux_rseq::rseq_cs_flags_RSEQ_CS_FLAG_NO_RESTART_ON_PREEMPT;
pub use linux_headers_linux_rseq::rseq_cs_flags_RSEQ_CS_FLAG_NO_RESTART_ON_SIGNAL;
pub use linux_headers_linux_rseq::rseq_cs_flags_RSEQ_CS_FLAG_NO_RESTART_ON_MIGRATE;
pub use linux_headers_linux_rseq::rseq_cs_flags;
pub use linux_headers_linux_rseq::rseq_cs;
pub use linux_headers_linux_rseq::rseq;
mod dlfcn;
...
mod sched;
pub use sched::sched_getcpu;
mod sys_auxv;
pub use sys_auxv::HWCAP_SPARC_FLUSH;
pub use sys_auxv::HWCAP_SPARC_STBAR;
pub use sys_auxv::HWCAP_SPARC_SWAP;
pub use sys_auxv::HWCAP_SPARC_MULDIV;
pub use sys_auxv::HWCAP_SPARC_V9;
pub use sys_auxv::HWCAP_SPARC_ULTRA3;
pub use sys_auxv::HWCAP_SPARC_BLKINIT;
pub use sys_auxv::HWCAP_SPARC_N2;
pub use sys_auxv::HWCAP_SPARC_MUL32;
pub use sys_auxv::HWCAP_SPARC_DIV32;
pub use sys_auxv::HWCAP_SPARC_FSMULD;
pub use sys_auxv::HWCAP_SPARC_V8PLUS;
pub use sys_auxv::HWCAP_SPARC_POPC;
pub use sys_auxv::HWCAP_SPARC_VIS;
pub use sys_auxv::HWCAP_SPARC_VIS2;
pub use sys_auxv::HWCAP_SPARC_ASI_BLK_INIT;
pub use sys_auxv::HWCAP_SPARC_FMAF;
pub use sys_auxv::HWCAP_SPARC_VIS3;
pub use sys_auxv::HWCAP_SPARC_HPC;
pub use sys_auxv::HWCAP_SPARC_RANDOM;
pub use sys_auxv::HWCAP_SPARC_TRANS;
pub use sys_auxv::HWCAP_SPARC_FJFMAU;
pub use sys_auxv::HWCAP_SPARC_IMA;
pub use sys_auxv::HWCAP_SPARC_ASI_CACHE_SPARING;
pub use sys_auxv::HWCAP_SPARC_PAUSE;
pub use sys_auxv::HWCAP_SPARC_CBCOND;
pub use sys_auxv::HWCAP_SPARC_CRYPTO;
pub use sys_auxv::HWCAP_SPARC_ADP;
pub use sys_auxv::getauxval;
mod sys_prctl;
pub use sys_prctl::prctl;
mod sys_rseq;
pub use sys_rseq::__rseq_offset;
pub use sys_rseq::__rseq_size;
pub use sys_rseq::__rseq_flags;
mod unistd;

...
pub use self::linux_headers_asm_unistd::__X32_SYSCALL_BIT;
...
pub use self::linux_headers_asm_unistd::__NR_vm86old;
...
pub use self::linux_headers_asm_unistd::__NR_get_thread_area;
...
pub use self::linux_headers_asm_unistd::__NR_arch_prctl;
...
pub use self::linux_headers_linux_auxvec::AT_SYSINFO;

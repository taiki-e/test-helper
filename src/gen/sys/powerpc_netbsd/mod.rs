...
mod machine_cpu;
pub use self::machine_cpu::CPU_CACHELINE;
pub use self::machine_cpu::CPU_TIMEBASE;
pub use self::machine_cpu::CPU_CPUTEMP;
pub use self::machine_cpu::CPU_PRINTFATALTRAPS;
pub use self::machine_cpu::CPU_CACHEINFO;
pub use self::machine_cpu::CPU_ALTIVEC;
pub use self::machine_cpu::CPU_MODEL;
